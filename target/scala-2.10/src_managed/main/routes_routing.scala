...
// @LINE:50
case controllers_Application_getEmailRecipientInfo23(params) => {
   call { 
        invokeHandler(controllers.Application.getEmailRecipientInfo, HandlerDef(this, "controllers.Application", "getEmailRecipientInfo", Nil,"GET", """ Email """, Routes.prefix + """email"""))
   }
}
        

// @LINE:51
case controllers_Application_addEmailRecipient24(params) => {
   call { 
        invokeHandler(controllers.Application.addEmailRecipient, HandlerDef(this, "controllers.Application", "addEmailRecipient", Nil,"POST", """""", Routes.prefix + """email"""))
   }
}
        

// @LINE:52
case controllers_Application_sendRecentRunsEmailReport25(params) => {
   call(params.fromPath[String]("filter1", None), params.fromPath[String]("filter2", None), params.fromPath[String]("param1", None), params.fromPath[String]("param2", None), params.fromPath[Int]("days", None)) { (filter1, filter2, param1, param2, days) =>
        invokeHandler(controllers.Application.sendRecentRunsEmailReport(filter1, filter2, param1, param2, days), HandlerDef(this, "controllers.Application", "sendRecentRunsEmailReport", Seq(classOf[String], classOf[String], classOf[String], classOf[String], classOf[Int]),"GET", """""", Routes.prefix + """sendemail/$filter1<[^/]+>/$filter2<[^/]+>/$param1<[^/]+>/$param2<[^/]+>/$days<[^/]+>"""))
   }
}
        

// @LINE:53
case controllers_Application_sendEmailReportNow26(params) => {
   call { 
        invokeHandler(controllers.Application.sendEmailReportNow, HandlerDef(this, "controllers.Application", "sendEmailReportNow", Nil,"POST", """""", Routes.prefix + """sendemailnow"""))
   }
}
