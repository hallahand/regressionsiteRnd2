...
def createFile(filter1:String, filter2:String, param1:String, param2:String): Call = {
   Call("GET", _prefix + { _defaultPrefix } + "getExcel/" + implicitly[PathBindable[String]].unbind("filter1", dynamicString(filter1)) + "/" + implicitly[PathBindable[String]].unbind("filter2", dynamicString(filter2)) + "/" + implicitly[PathBindable[String]].unbind("param1", dynamicString(param1)) + "/" + implicitly[PathBindable[String]].unbind("param2", dynamicString(param2)))
}
                                                

// @LINE:25
def listPageByRun(p:Int = 0, s:String = "name", o:String = "asc", id:Long, f:String = "", d:String): Call = {
   Call("GET", _prefix + { _defaultPrefix } + "pagesbyrun/" + implicitly[PathBindable[Long]].unbind("id", id) + "/" + implicitly[PathBindable[String]].unbind("d", dynamicString(d)) + queryString(List(if(p == 0) None else Some(implicitly[QueryStringBindable[Int]].unbind("p", p)), if(s == "name") None else Some(implicitly[QueryStringBindable[String]].unbind("s", s)), if(o == "asc") None else Some(implicitly[QueryStringBindable[String]].unbind("o", o)), if(f == "") None else Some(implicitly[QueryStringBindable[String]].unbind("f", f)))))
}
...
def recentRuns(filter1:String, filter2:String, param1:String, param2:String, days:Int): Call = {
   Call("GET", _prefix + { _defaultPrefix } + "recentRuns/" + implicitly[PathBindable[String]].unbind("filter1", dynamicString(filter1)) + "/" + implicitly[PathBindable[String]].unbind("filter2", dynamicString(filter2)) + "/" + implicitly[PathBindable[String]].unbind("param1", dynamicString(param1)) + "/" + implicitly[PathBindable[String]].unbind("param2", dynamicString(param2)) + "/" + implicitly[PathBindable[Int]].unbind("days", days))
}
...
// @LINE:51
def addEmailRecipient(): Call = {
   Call("POST", _prefix + { _defaultPrefix } + "email")
}
                                                

// @LINE:50
def getEmailRecipientInfo(): Call = {
...
def dataList(filter1:String, filter2:String, param1:String, param2:String): Call = {
   Call("GET", _prefix + { _defaultPrefix } + "dataList/" + implicitly[PathBindable[String]].unbind("filter1", dynamicString(filter1)) + "/" + implicitly[PathBindable[String]].unbind("filter2", dynamicString(filter2)) + "/" + implicitly[PathBindable[String]].unbind("param1", dynamicString(param1)) + "/" + implicitly[PathBindable[String]].unbind("param2", dynamicString(param2)))
}
...
// @LINE:53
def sendEmailReportNow(): Call = {
   Call("POST", _prefix + { _defaultPrefix } + "sendemailnow")
}
...
// @LINE:52
def sendRecentRunsEmailReport(filter1:String, filter2:String, param1:String, param2:String, days:Int): Call = {
   Call("GET", _prefix + { _defaultPrefix } + "sendemail/" + implicitly[PathBindable[String]].unbind("filter1", dynamicString(filter1)) + "/" + implicitly[PathBindable[String]].unbind("filter2", dynamicString(filter2)) + "/" + implicitly[PathBindable[String]].unbind("param1", dynamicString(param1)) + "/" + implicitly[PathBindable[String]].unbind("param2", dynamicString(param2)) + "/" + implicitly[PathBindable[Int]].unbind("days", days))
}
                                                

// @LINE:14
def listRun(p:Int = 0, s:String = "name", o:String = "asc", f:String = "", filterBy:String): Call = {
   Call("GET", _prefix + { _defaultPrefix } + "runs/" + implicitly[PathBindable[String]].unbind("filterBy", dynamicString(filterBy)) + queryString(List(if(p == 0) None else Some(implicitly[QueryStringBindable[Int]].unbind("p", p)), if(s == "name") None else Some(implicitly[QueryStringBindable[String]].unbind("s", s)), if(o == "asc") None else Some(implicitly[QueryStringBindable[String]].unbind("o", o)), if(f == "") None else Some(implicitly[QueryStringBindable[String]].unbind("f", f)))))
}
...
// @LINE:51
def addEmailRecipient : JavascriptReverseRoute = JavascriptReverseRoute(
   "controllers.Application.addEmailRecipient",
   """
      function() {
...
// @LINE:50
def getEmailRecipientInfo : JavascriptReverseRoute = JavascriptReverseRoute(
   "controllers.Application.getEmailRecipientInfo",
   """
      function() {
...
// @LINE:53
def sendEmailReportNow : JavascriptReverseRoute = JavascriptReverseRoute(
   "controllers.Application.sendEmailReportNow",
   """
      function() {
      return _wA({method:"POST", url:"""" + _prefix + { _defaultPrefix } + """" + "sendemailnow"})
      }
   """
)
...
// @LINE:52
def sendRecentRunsEmailReport : JavascriptReverseRoute = JavascriptReverseRoute(
   "controllers.Application.sendRecentRunsEmailReport",
   """
      function(filter1,filter2,param1,param2,days) {
      return _wA({method:"GET", url:"""" + _prefix + { _defaultPrefix } + """" + "sendemail/" + (""" + implicitly[PathBindable[String]].javascriptUnbind + """)("filter1", encodeURIComponent(filter1)) + "/" + (""" + implicitly[PathBindable[String]].javascriptUnbind + """)("filter2", encodeURIComponent(filter2)) + "/" + (""" + implicitly[PathBindable[String]].javascriptUnbind + """)("param1", encodeURIComponent(param1)) + "/" + (""" + implicitly[PathBindable[String]].javascriptUnbind + """)("param2", encodeURIComponent(param2)) + "/" + (""" + implicitly[PathBindable[Int]].javascriptUnbind + """)("days", days)})
      }
   """
)
...
// @LINE:51
def addEmailRecipient(): play.api.mvc.HandlerRef[_] = new play.api.mvc.HandlerRef(
   controllers.Application.addEmailRecipient(), HandlerDef(this, "controllers.Application", "addEmailRecipient", Seq(), "POST", """""", _prefix + """email""")
)
                      

// @LINE:50
def getEmailRecipientInfo(): play.api.mvc.HandlerRef[_] = new play.api.mvc.HandlerRef(
   controllers.Application.getEmailRecipientInfo(), HandlerDef(this, "controllers.Application", "getEmailRecipientInfo", Seq(), "GET", """ Email """, _prefix + """email""")
)
...
// @LINE:53
def sendEmailReportNow(): play.api.mvc.HandlerRef[_] = new play.api.mvc.HandlerRef(
   controllers.Application.sendEmailReportNow(), HandlerDef(this, "controllers.Application", "sendEmailReportNow", Seq(), "POST", """""", _prefix + """sendemailnow""")
)
...
// @LINE:52
def sendRecentRunsEmailReport(filter1:String, filter2:String, param1:String, param2:String, days:Int): play.api.mvc.HandlerRef[_] = new play.api.mvc.HandlerRef(
   controllers.Application.sendRecentRunsEmailReport(filter1, filter2, param1, param2, days), HandlerDef(this, "controllers.Application", "sendRecentRunsEmailReport", Seq(classOf[String], classOf[String], classOf[String], classOf[String], classOf[Int]), "GET", """""", _prefix + """sendemail/$filter1<[^/]+>/$filter2<[^/]+>/$param1<[^/]+>/$param2<[^/]+>/$days<[^/]+>""")
)
