...
public class Run extends Model {
	 ...
	 * Param1 and Param2 are the data types you are looking for (example: Format or Date)					: column names
	 * Filter1 and Filter2, respectively, are what you are searching for (example: PDF or 12/12/2000)	: column values
	...
	public static List<Run> getRunsByFormatID(Integer formatId)	{
		List<Run> list = find.where()
